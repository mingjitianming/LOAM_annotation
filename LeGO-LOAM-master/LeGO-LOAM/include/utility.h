...
extern const string pointCloudTopic = "/points_raw";//"/velodyne_points";
...
extern const float segmentTheta = 60.0/180.0*M_PI; // decrese this value may improve accuracy //点云分割时的角度跨度上限（π/3
...
extern const float historyKeyframeSearchRadius = 20;//7.0; // key frame that is within n meters from current pose will be considerd for loop closure
